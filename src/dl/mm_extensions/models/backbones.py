...
class Bottleneck(BaseModule):
    ...
    def forward(self, x):
        ...
        def _inner_forward(x):
            ...
            out = self.conv3(out)
            out = self.norm3(out)
            # print(self.conv3.state_dict()["weight"][0, :5, 0, 0])
            out = self.eca(out)
...
class ECAResNet(BaseModule):
    ...
    def __init__(
        ...
        super(ECAResNet, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ECAResNet, self).train(mode)
        self._freeze_stages()
