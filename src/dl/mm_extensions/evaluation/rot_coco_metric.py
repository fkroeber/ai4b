...
try:
    import torch  # necessary for fast_coco_eval
...
class RotCocoMetric(CocoMetric):
    """Rotated COCO evaluation metric.
    Base src: mmrotate\evaluation\metrics\rotated_coco_metric.py.
    Bbox eval removed such that speed-up for segmentation eval by fastcocoeval can be leveraged.
    """
